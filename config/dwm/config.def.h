...
static const char col_fgs[]         = "#F5F5F5";
static const char col_bgs[]         = "#455A64";
static const char col_bds[]	    = "#005577";

static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_fg, col_bg, col_bd },
	[SchemeSel]  = { col_fgs, col_bgs,  col_fgs  },
};
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_v,      incnmaster,     {.i = +1 } }, /* normal */
	{ MODKEY,                       XK_v,      incnmaster,     {.i = -1 } }, /* vertical */
